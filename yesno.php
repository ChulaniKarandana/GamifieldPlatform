...
if (isset($_POST['submit'])){
	$mysqli = NEW MySQLi('localhost','root','chul@P292','gamifield');  //steps to insert the array of added questions
	$question = $_POST['question'];
	$sub_id = $_SESSION["sub"] ;
	$task_id = $_SESSION["task"];
	foreach($question as $key => $value){
		$query = "INSERT INTO yesno(task_id,sub_id,yesno_q,yesno_ans) VALUES($task_id,$sub_id,'".$mysqli -> real_escape_string($value)."','')";
	...
	$mysqli -> close();
	header("location:../../semester5project/adder_tasks/select_task_yesno.php");
}
?>
...
<script>
$(document).ready(function(e){  //js function to adding and removing text fields dynamically
	//variables
	var html = '</p><div><li>Question: <input type = "text" placeholder = "Enter the question" name = "question[]" id = "childquestion"/><a href = "#" id = "remove"><font color = "white"> Remove</font></a></li></div>';
...
<div class = "my">
	<h1 align = "center"><font color = "blue"> Gamifield Crowdsourcing Platform <br> Upload Your Yes/No Questions Here</font></h1>
</div>
<div class="login-box animated fadeInRight">
	<fieldset>
		<br><br>
		 <form method = "POST" name = "add_q">
		 <div id = "container">
		 <li >Question: <input type = "text" placeholder = "Enter the question" name = "question[]" id = "question"/>
		 <a href = "#" id = "add"><font color = "white">Add More Questions</font></a>
		 </li>
		 </div>
		 <br> <br>
