...
<div class = "my">
	<h1 align = "center"><font color = "blue"> Gamifield Crowdsourcing Platform <br>Change Your Password</font></h1>
</div>
<form method = "post" action = "adder_change_password.php" align = "center">
	<div class="login">
		<div class = "login-box animated fadeInDown">
			<fieldset>
				<img src = "images/key.gif" width = "350px" height = "225px"><br><br>
                    <div>
                ...
                <div>
					Confirm New Password: <input type="password" name="password2"/><br>
                </div>
...
if ((isset($_POST['username'])) && (isset($_POST['password1'])) && (isset($_POST['password2']))){
	...
	echo "<br>";
	//echo "connected<br>";
	$result = mysqli_query($conn,"SELECT add_user FROM adder_user WHERE add_user='".$user."'");
		if((mysqli_num_rows($result) == 0)) {
			...
			if ("$pass1" == "$pass2"){
				$sql = "UPDATE adder_user SET add_pass='$pass' WHERE add_user='".$user."'";
