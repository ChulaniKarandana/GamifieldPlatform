...
<div class = "my">
	<h1 align = "center"><font color = "blue"> Gamifield Crowdsourcing Platform <br> Welcome to Translation Generator</font></h1>
</div>

<form method = "post" action = "navigation_trans_lan.php" align = "center">
	<div class="login">
		<div class = "login-box animated fadeInDown">
			<fieldset>
				<img src = "images/Translate.gif" width = "350px" height="200px"><br><br>
