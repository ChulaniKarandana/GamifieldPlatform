...
<head>
  <meta charset="UTF-8">
  <title>Play Image Labeling</title>
...
<body>
  ...
  <aside class="sidebar">
  <br><br>
  <img src = "images/im.gif" width = "540px" height = "600px">
</aside>
...
<div class = "my">
	<font color="blue">
	<h1 align = "center"> Gamifield Image Labeling</h1>
	</font>
</div>
<form method = "post" action = "do_image_store.php" align = "center">
	<div class="login">
		<div class = "login-box animated fadeInLeft">
		<fieldset>
			<!--<img src = "../adder_tasks/images/brain_q.jpg" width = "800px" height = "150px">--><br><br>
			<label>
			<?php
				include "db_mysqli.php";
				$task = $_GET["sent"];   //taking related task and subtask
				$subtask = $_GET["sub"];
				$_SESSION['task'] = $task;
				...
				$default = '';
				$question = '';
				$query_q = 'SELECT *FROM image WHERE task_id = "'.$task.'" and sub_id = "'.$subtask.'" and image_ans = "'.$default.'" LIMIT 1';
				$result_q = mysqli_query($conn,$query_q);

				 while($row1 = mysqli_fetch_array($result_q))
				 {
					 $question = $row1['image_q']; //getting questions and choices
					 $id =$row1['image_id'];
					 $photo = $row1['photo'];
				 }
				 if ($question == ''){ //informing task completion
				 ...
				 else{ //displaying question with info
					 echo '<img src="data:image/jpeg;base64,'.base64_encode($photo).'" width = "600" height = "350"/>';
					 echo '<br>';
					 echo $question;
					 $_SESSION['id'] = $id;
			?><br><br>
