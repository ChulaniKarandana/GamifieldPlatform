...
<body>
  ...
  <aside class="sidebar">
  <br><br>
  <img src = "images/3magine.gif" width = "540px" height = "600px">
</aside>
...
<div class = "my">
	<font color="blue">
	<h1 align = "center"> Gamifield 3 - 1 Answer Generator</h1>
	</font>
</div>
<form method = "post" action = "do_mcq3_store.php" align = "center">
	<div class="login">
		...
		<fieldset>
			...
			<?php
				...
				$task = $_GET["sent"];    //getting selected task
				$subtask = $_GET["sub"];
				$_SESSION['task'] = $task;
				...
				$default = '';
				$question = '';
				$query_q = 'SELECT *FROM mcq3 WHERE task_id = "'.$task.'" and sub_id = "'.$subtask.'" and mcq3_ans = "'.$default.'" LIMIT 1';
				$result_q = mysqli_query($conn,$query_q);

				 while($row1 = mysqli_fetch_array($result_q))
				 {
					 $question = $row1['mcq3_q'];   //getting questions
					 $id =$row1['mcq3_id'];
					 $choice1 = $row1['mcq3_choice1'];
					 $choice2 = $row1['mcq3_choice2'];
					 $choice3 = $row1['mcq3_choice3'];
				 }
				 if ($question == ''){  //informing success of completing the task
					...
					<?php
					 ...
					 echo '<br>';
					 echo $question;   //displaying question with image
					 $_SESSION['id'] = $id;
			?></label><br><br>
			<div class = "Myradio">
				...
				<input type = "radio" name = "choice" value = <?php echo $choice3; ?>><?php echo $choice3;?>
			</div>
			<br>
