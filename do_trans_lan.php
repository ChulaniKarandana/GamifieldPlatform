...
<body>
  ...
  <aside class="sidebar">
  <br>
  <img src = "images/mcq4.gif" width = "400px" height = "800px">
</aside>
...
<form method = "post" action = "do_trans_lan_store.php" align = "center">
	<div class="login">
		<br>
		<fieldset>
			<label>
			<?php
				...
				$query_q = 'SELECT *FROM trans_lan WHERE task_id = "'.$task.'" and sub_id = "'.$subtask.'" and lan_ans = "'.$default.'" LIMIT 1';
			...
			<br><br>
			<div class = "Myradio">
				Your Translation:<br><textarea name = "answer" cols = "30"></textarea><br><br>
				<script>
