...
<form method = "post" action = "crowd_change_password.php" align = "center">
	<div class="login">
		<div class = "login-box animated fadeInDown">
			<fieldset>
				<img src = "images/security.gif" width = "350px" height = "225px"><br><br>
                <div>
...
if ((isset($_POST['username'])) && (isset($_POST['password1'])) && (isset($_POST['password2']))){
	...
	echo "<br>";
	//echo "connected<br>";
	$result = mysqli_query($conn,"SELECT crowd_user FROM crowd_user WHERE crowd_user='".$user."'");
		if((mysqli_num_rows($result) == 0)) {
			...
			if ("$pass1" == "$pass2"){
				$sql = "UPDATE crowd_user SET crowd_pass='$pass' WHERE crowd_user='".$user."'";
