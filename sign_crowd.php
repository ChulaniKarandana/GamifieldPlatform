...
<br>
<form method = "post" action = "sign_crowd.php" align = "center">
    <div class="login">
...
<?php
if ((isset($_POST["user_name"])) && (isset($_POST["first_name"])) && (isset($_POST["last_name"])) && (isset($_POST["address"])) && (isset($_POST["country"])) && (isset($_POST["email"])) && (isset($_POST["tp"])) && (isset($_POST["pass1"])) && (isset($_POST["pass2"]))) {
...
// Access and use your preferred validation result objects
    ...
    if ($new_password1 == $new_password2 && $new_username != '' && $new_firstname != '' && $new_lastname != '' && $new_add != '' && $new_country != '' && $new_email != '' && $new_tp != '' && $new_password1 != '') {         //validate confirming password
        $new_password = md5($new_password1);       //encrypting password
        $query = "INSERT INTO crowd_user(crowd_user,crowd_first,crowd_last,address,crowd_country,crowd_mail,crowd_tel,crowd_pass,points) values('$new_username','$new_firstname','$new_lastname','$new_add','$new_country','$new_email','$new_tp','$new_password',0)"; //insert values into database
