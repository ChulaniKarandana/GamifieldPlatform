...
<head>
  <meta charset="UTF-8">
  <title>Translation Task Pool</title>
...
<fieldset>
	<?php
		$sql = mysqli_query($conn,"select distinct task_id,task_name,sub_id,company,task_desc from trans_lan natural join task where lan_ans = ''"); 
	...
	<p>
		...
		<div class = "article">
			...
			<a href="do_trans_lan.php?sent=<?php echo $taskID;?>&sub=<?php echo $subID;?>">Select the Task</a> 
		</div>
		</div>
	</p>
	<?php
