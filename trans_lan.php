...
<div class="my">
<h1 align = "center"><font color = "blue"> Gamifield Crowdsourcing Platform - Upload the translation</font></h1>
</div>
	<form method = "post" action = "trans_lan.php" align = "center">
		<div class="login">
		</div><br>
		<div class="login-box animated fadeInUp">
			<fieldset>
				Enter the text:<br><textarea name = "text" id = "text" cols = "200"></textarea>
				<script>
				...
				<br><br>
				Enter the required language: <input type = "text" name = "lan"/><br><br>
