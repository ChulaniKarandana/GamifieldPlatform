...
if (isset($_POST['submit'])){
	...
	//inserting arrays of input values into database
	...
	foreach($question as $key => $value){
		$query = "INSERT INTO mcq3(task_id,sub_id,mcq3_q,mcq3_choice1,mcq3_choice2,mcq3_choice3,mcq3_ans) VALUES($task_id,$sub_id,'".$mysqli -> real_escape_string($value)."','".$mysqli -> real_escape_string($choice1[$key])."','".$mysqli -> real_escape_string($choice2[$key])."','".$mysqli -> real_escape_string($choice3[$key])."','')";
	...
	$mysqli -> close();
	header("location:../../semester5project/adder_tasks/select_task_mcq_3.php");
}
?>
...
<div class="login-box animated fadeInRight">
	<fieldset>
		<form method = "POST" name = "add_q_3">
			<div id = "container">
				<li><input type = "text" placeholder = "Enter the question" name = "question[]" id = "question" /><br><br><input type = "text" placeholder = "Choice 1" name="choice1[]" id = "choice1"/><br><br><input type = "text" placeholder = "Choice 2" name="choice2[]" id = "choice2"/><br><br><input type = "text" placeholder = "Choice 3" name="choice3[]" id = "choice3"/>
				<a href = "#" id = "add"><font color = "white">More Questions...</font></a>
				</li>
			</div><br> <br>
