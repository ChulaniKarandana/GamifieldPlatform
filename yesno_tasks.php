...
<fieldset>
	<?php
		$sql = mysqli_query($conn,"select distinct task_id,task_name,sub_id,company,task_desc from yesno natural join task where yesno_ans = ''"); 
	...
	<p>
		...
		<div class = "article">
			...
			<a href="do_yesno.php?sent=<?php echo $taskID;?>&sub=<?php echo $subID;?>">Select the Task</a> 
		</div>
		</div>
