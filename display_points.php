...
<form method = "post" action = "navigation_yesno.php" align = "center">
	<div class="login">
		<div class = "login-box animated fadeInDown">
			<fieldset>
				<img src = "images/point_gif.gif"  width = "400px" height = "300px"><br><br>
				<?php
					$crowd_name = $_SESSION['username'];
					$query_display_point = 'SELECT *FROM crowd_user WHERE crowd_user = "'.$crowd_name.'"  LIMIT 1';
					$result_display_point = mysqli_query($conn,$query_display_point); //select questions of the selected task

					while($row3 = mysqli_fetch_array($result_display_point))
					{
				...
				<div class = "login-box animated tada">
					<font size = "30px">
                        <div data-color="red"><font color="yellow"><?php echo $display_points; echo " "; ?></font>  </div>points</font>
				</div>
			</fieldset>
		</div>
	</div>
