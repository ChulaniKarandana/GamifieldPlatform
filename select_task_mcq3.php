    ...
    <ul class="nano-content">
      ...
      <li class="sub-menu">
        ...
        <ul>
          ...
          <li><a href="show_completed.php">Completed Tasks</a>
          </li>
        </ul>
      </li>
      <li class="sub-menu">
...
<form method = "post" action = "navigation_mcq3.php" align = "center">
		<div class="login">
		<fieldset>
				Select the Task:<?php $company = $_SESSION['user_company'];
	$conn1 = new PDO('mysql:host = localhost;dbname=gamifield','root','chul@P292');
	$sql = 'SELECT task_name FROM task where company = "'.$company.'"';
...
<br><br>
Points: <input type = "number" name = "points" value = "points"/>
